package cn.admilk.dglabweb.client;
...
import cn.admilk.dglabweb.platform.forge.ForgeRuleEventBridge;
import cn.admilk.dglabweb.rule.RuleEventContext;
import cn.admilk.dglabweb.rule.TriggerRegistry;
import cn.admilk.dglabweb.security.EncryptedChatSignal;
...
@Mod.EventBusSubscriber(modid = cn.admilk.dglabweb.DgLabWebMod.MODID, value = Dist.CLIENT)
public final class ClientHooks {
    ...
    private static void drainPendingSignals(ClientPlayerEntity player) {
        ...
        while ((triggerId = PENDING_SIGNAL_TRIGGERS.poll()) != null) {
            fireTrigger(ForgeRuleEventBridge.createSignalContext(player, triggerId));
        }
    }
