...
public class ConfirmDialogScreen extends BaseScreen {
    ...
    protected void buildWidgets() {
        ...
        if (compact) {
            ...
            this.addButton(new StyledButton(il, btnY + UiConstants.BTN_STRIDE, iw, UiConstants.BTN_HEIGHT, new StringTextComponent("取消"), StyledButton.Variant.SECONDARY, button -> this.minecraft.displayGuiScreen(this.parent)));
        } else {
            ...
            this.addButton(new StyledButton(this.panelLeft + 136, btnY, 110, UiConstants.BTN_HEIGHT, new StringTextComponent("取消"), StyledButton.Variant.SECONDARY, button -> this.minecraft.displayGuiScreen(this.parent)));
        }
    }
