...
public class PasswordGateScreen extends Screen {
    private static final Component TITLE = Component.literal("输入密码");
    private static final Component TODAY_PASSWORD = Component.literal("今日密码");
    private static final Component UNLOCK = Component.literal("解锁");
    private static final Component PASTE = Component.literal("粘贴");
