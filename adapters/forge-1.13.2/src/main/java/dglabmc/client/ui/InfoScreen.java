...
public class InfoScreen extends BaseScreen {
    ...
    protected void buildWidgets() {
        this.scrollOffset = 0;
        this.addButton(new StyledButton(this.panelLeft + this.panelWidth - 128, this.panelTop + this.panelHeight - 34, 110, UiConstants.BTN_HEIGHT, new StringTextComponent("返回"), StyledButton.Variant.SECONDARY, button -> this.minecraft.displayGuiScreen(this.parent)));
    }
