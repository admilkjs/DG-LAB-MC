...
public final class DgLabMcMod {
    ...
    private void onCommonSetup(FMLCommonSetupEvent event) { AppServices.get().initialize(); }
    private void onClientSetup(FMLClientSetupEvent event) { ClientHooks.registerKeyBinding(); }
}
