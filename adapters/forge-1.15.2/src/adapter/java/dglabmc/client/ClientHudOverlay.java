...
public final class ClientHudOverlay {
    ...
    private static void drawLine(MatrixStack matrixStack, FontRenderer font, int x, int y, String line, boolean active) {
        font.drawString(line, (float) x, (float) y, UiPalette.TEXT_PRIMARY);
        font.drawString("\u25CF", (float) (x + font.getStringWidth(line) + 6), (float) y, active ? UiPalette.SUCCESS : UiPalette.DANGER);
    }
